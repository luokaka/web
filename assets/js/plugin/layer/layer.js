...
! function(a, b) {
    ...
    a.layer = {
        ...
        config: function(a, b) {
            var d = 0;
            return a = a || {}, layer.cache = e.config = c.extend(e.config, a), layer.path = e.config.path || layer.path, "string" == typeof a.extend && (a.extend = [a.extend]), layer.use("/dyview/assets/js/libs/layer/skin/layer.css", a.extend && a.extend.length > 0 ? function f() {
                var c = a.extend;
    ...
    g.anim = ["layui-anim", "layui-anim-01", "layui-anim-02", "layui-anim-03", "layui-anim-04", "layui-anim-05", "layui-anim-06"], f.pt.config = {
        ...
        var c = this,
            ...
            k = f.title ? '<div class="layui-layer-title" style="' + (i ? f.title[1] : "") + '"><h2><span>' + (i ? f.title[0] : f.title) + "</span></h2></div>" : "";
        ...
        e.run(), layer.use("/dyview/assets/js/libs/layer/skin/layer.css")
    }()
}(window);
