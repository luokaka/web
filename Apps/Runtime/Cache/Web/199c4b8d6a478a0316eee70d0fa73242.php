                ...
                <div class="page-container monitor-cpu">
                    ...
                    <div class="bd bd-load">
                        <div class="alert mb15 bgcolor">
                            <p>
                                <span class="fr">
                              流入最高峰值为： <b class="c-red mr50">95.46KB</b>
                              总流量峰值为：<b class="c-green">98.63KB</b>
                            </span> 流出最高峰值为： <b class="c-blue">5.01KB</b>
                            </p>
                        </div>
                        <div class="echart mr0" id="loadChart">
                            <img src="assets/images/member/liyl-char.png">
                        </div>
                    </div>
